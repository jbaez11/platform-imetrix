...
export default function Agents(){
    const dataAgentes = async()=>{
		...
		getAgentes.data.forEach((agentes,index)=>{
			dataSet[index] = [(index+1),
				agentes.name,agentes.identification,agentes.gender,
				[agentes._id, agentes.name,agentes.identification,agentes.gender]];
		})
			...
			$('.table').DataTable({
				...
				columns: [
						...
						render: function(data){
							...
							<a href="" class="editarInputs" data-toggle="modal" data-target="#editAgent" data="${data}">
                        ...
                        <div className="col-lg-12">
                            <div className="card card-primary card-outline">
                                <div className="card-header">
                                	<h5 className="m-0">
                                        <button className="btn btn-warning" data-toggle="modal" data-target="#addAgent">Crear nuevo agente</button>
                                        <button className="btn btn-success ml-4" data-toggle="modal" data-target="#">Descargar</button>
                                        <button className="btn btn-primary ml-4" data-toggle="modal" data-target="#">Subir</button>
                                    </h5>
                                </div>
