        ...
        <div className="modal-dialog">
            ...
            <form onChange={cambiaFormPost} onSubmit={submitPost}>
                <div className="modal-body">
                    ...
                    <div className="form-group">
                        <label className="small text-secondary" htmlFor="editarPorcentaje">
...
const putData = data =>{
    ...
    const url = `${rutaAPITableros}/igsSufiCO/editCluster/${data.id}`;
...
const deleteData = data =>{
    const url = `${rutaAPITableros}/igsSufiCO/deleteCluster/${data}`
    const token =  localStorage.getItem("ACCESS_TOKEN");
    const params = {
