...
//  end  utilizadas en la TERCERA tabla
  ...
  const filtrar2=(terminoBusqueda)=>{
    var resultadoBusqueda = tableGrabaciones.filter((elemento)=>{
        if(elemento.keyfile.toString().toLowerCase().includes(terminoBusqueda.toLowerCase())|| elemento.keyfile.toString().toUpperCase().includes(terminoBusqueda.toUpperCase())){
            return elemento;
        }
    })
                        ...
                        <div className="col-lg-12">
                                    <div className="card card-primary card-outline">
                                        ...
                                        <div className="container">
                                            <div className="row">
                                                ...
                                                {showCalendar ? (
                                                    ...
                                                    <div style={{ height: "450px", width: "300px",fontSize:"x-small" }}>
                                                    <br/>
                                                    <p style={{"display":"inline"}}>
                                                        {" "}
                                                        {startDate
                                                ...
                                                <span className="" style={{"color":"#FF9B00",fontSize:"250%"}}>{sumTotalGrabaciones}</span>
                                                </div>
                                                <div className="col-sm text-center">
                                                <h5 className="" style={{"color":"#FF9B00"}}>
                                                AFECTADAS <span style={{"color":"#CACACA"}}> POR </span> NO PERMITIDAS
                                                </h5>
                                                <span className="" style={{"color":"#FF9B00",fontSize:"250%"}}>{grabacionesNoPermitidas}</span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="card-body">
                                            ...
                                            <button className="btn btn-warning btn-sm rounded-pill" hidden={activeTabla1 ? false:true} onClick={()=>{
                                                filtrar('')
                                                filtrar2('')
                                                setBusqueda('')
                                                //setAgentes([])
                                            ...
                                            <br/>
                                             ...
                                             {/* <div className="table-responsive"> */}
                                                 <table className="table  table-borderless table-hover" hidden={activeTabla1 ? false:true}>
                                                     <thead style={{backgroundColor:"#CACACA", color:"white",fontSize:"small"}}>
                                                        <tr >
                                                            <th className="text-center" scope="col">NOMBRE</th>
                                                            <th className="text-center" scope="col">GRABACIONES</th> 
                                                            <th className="text-center" scope="col">INFALTABLE</th> 
                                                            <th className="text-center" scope="col">INFALTABLE NO HALLADA</th> 
                                                            <th className="text-center" scope="col">NO PERMITIDA</th> 
                                                            <th className="text-center" scope="col">RECOMENDACION</th>
                                                     ...
                                                     <tbody style={{fontSize:"small"}}>
                                                         {agentes.map((agent)=>(
                                                             <tr key={agent.name}>
                                                                 ...
                                                                 <td >{agent.name}</td>
                                                                 <td className="text-center">{agent.results.recordings}</td>
                                                                 <td className="text-center">{agent.results.positivesOfRequired}</td>
                                                                 <td className="text-center">{agent.results.negativesOfRequired}</td>
                                                                 <td className="text-center">{agent.results.positivesOfNotAllowed}</td>
                                                                 <td className="text-center">{agent.results.positivesOfRecommendation}</td>
                                                                 <td className="text-center"><button className="btn btn-success btn-sm rounded-pill" onClick={()=>{
                                             ...
                                             <br/>
                                            <br/>
                                             <button className="btn btn-warning btn-sm rounded-pill" hidden={activeTabla2 ? false:true} onClick={()=>{
                                                filtrar('')
                                                setGrabaciones([])
                                                setKeywords([])
                                                setActiveTabla3(false)
                                            ...
                                            <br/>
                                             {/* <div className="table-responsive"> */}
                                             <table className="table  table-borderless table-hover" hidden={activeTabla2 ? false:true}>
                                                     <thead  style={{backgroundColor:"#CACACA", color:"white", fontSize:"small"}}>
                                                        <tr>
                                                     ...
                                                     <tbody style={{fontSize:"small"}}>
                                                         {grabaciones.map((grabacion)=>(
                                                             <tr key={grabacion.keyfile}>
                                                                 ...
                                                                 <td>{grabacion.results.positivesOfRecommendation}</td>
                                                                 <td><button className="btn btn-success btn-sm rounded-pill" onClick={()=>{
                                             ...
                                             <br/>
                                            <br/>
                                             <button className="btn btn-warning btn-sm rounded-pill" hidden={activeTabla3 ? false:true} onClick={()=>{
                                            ...
                                            <br/>
                                             {/* <div className="table-responsive"> */}
                                                  <table className="table  table-borderless table-hover" hidden={activeTabla3 ? false:true}>
                                                     <thead style={{backgroundColor:"#CACACA", color:"white", fontSize:"small"}}>
                                                        <tr>
                                                            <th>KEYWORD</th>
                                                            <th>CATEGORIA</th> 
