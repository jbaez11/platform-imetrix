...
export default function Camaings(){
    ...
    $(function(){
        ...
        tablaCampaing.on("order.dt search.dt", function(){
            tablaCampaing.column(0, {"search":"applied", "order":"applied"}).nodes().each(function(cell, i){
                cell.innerHTML = i+1
            })
        }).draw()
    })
                        ...
                        <div className="col-lg-12">
                                    <div className="card card-warning">
                                        <div style={{backgroundColor:"#FF9B00"}} className="card-header">
                                            <h5 className="m-0">
                                                <button className="btn btn-light limpiarFormulario" data-toggle="modal" data-target="#addCampaing"> Crear Nueva Campaña</button>
                                            </h5>
                                        </div>
